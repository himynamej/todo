...
import (
	...
	"github.com/himynamej/todo/business/sdk/migrate"
	"github.com/himynamej/todo/business/sdk/sqldb"
	"github.com/himynamej/todo/foundation/docker"
...
func New(t *testing.T, testName string) *Database {
	...
	return &Database{
		DB:        db,
		Log:       log,
		BusDomain: newBusDomains(log, db, ctrl),
	}
}
